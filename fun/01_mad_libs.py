...
def get_story(adjective1: str, noun1: str, verb1: str, noun2: str, verb2: str) -> str:
    ...
    {noun1}: "I'm just {verb1}ing, why? what's the big deal?"
    ...
    {noun2}: "That's probably a good idea. Why don't we {verb2} instead?"
...
def main() -> None:
    ...
    adjective1: str = input(f"How would describe quality of {noun1} (lazy/sleepy/active/sharp/stupid...)?: ")
